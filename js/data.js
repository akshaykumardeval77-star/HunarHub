/**
 * HunarHub - Initial Seed Data
 * Pre-seeded mock database stored in localStorage
 */

const INITIAL_HUNARHUB_DATA = {
  categories: [
  ...
  orders: [
    {
      ...
      totalAmount: 2190,
      paymentMethod: "Cash on Delivery / Local Wallet",
      status: "Delivered",
  ...
  reviews: [
    {
      ...
      rating: 5,
      date: "2026-09-02",
      comment: "Ramcharan ji made the most beautiful earthen matka for our home. The water tastes naturally cool and sweet! Delivery was fast and humble."
    },
    {
      id: "rev_302",
      ...
      rating: 5,
      date: "2026-09-03",
      comment: "Solid genuine leather Kolhapuris! Ramesh cobbler fixed the fitting perfectly according to my wide foot size. Highly recommended local micro-entrepreneur."
    }
  ]
};
